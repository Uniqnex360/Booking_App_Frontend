  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'wine-radial': 'radial-gradient(circle at 30% 20%, hsl(var(--wine-600) / 0.15), transparent 60%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      boxShadow: {
        'wine': '0 4px 24px -4px hsl(var(--wine-700) / 0.25)',
        'wine-lg': '0 12px 40px -8px hsl(var(--wine-700) / 0.3)',
